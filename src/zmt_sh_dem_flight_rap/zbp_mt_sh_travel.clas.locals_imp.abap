CLASS lsc_zmt_sh_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_zmt_sh_travel IMPLEMENTATION.
   ...
   IF update-travel IS NOT INITIAL.
     ...
     LOOP AT update-travel ASSIGNING FIELD-SYMBOL(<travel_log_update>).
       ...
       IF <travel_log_update>-%control-CustomerId = if_abap_behv=>mk-on.
         ...
         <travel_log_db>-changed_field_name = 'mouritech_customer'.
       ...
       IF <travel_log_update>-%control-AgencyId = if_abap_behv=>mk-on.
         <travel_log_db>-change_id = cl_system_uuid=>create_uuid_x16_static( ).
         <travel_log_db>-changed_field_name = 'mouritech_agency'.
...
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    TYPES: ty_helper_type TYPE TABLE FOR CREATE ZMT_SH_TRAVEL.
*    METHODS precheck_sheeba_reuse
*      IMPORTING
*        entities_c TYPE ty_helper_type
*      EXPORTING
*        reported   TYPE any
*        failed     TYPE any.
    ...
    METHODS earlynumbering_create FOR NUMBERING
      ...
      types:  t_entity_create type table for create zmt_sh_travel,
              t_entity_update TYPE table for update zmt_sh_travel,
              t_entity_rep type table for REPORTED zmt_sh_travel,
              t_entity_err type table for FAILED zmt_sh_travel.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  data : ls_result like line of result.
   ...
   READ ENTITIES OF zmt_sh_travel in LOCAL MODE
       ENTITY travel
   ...
   loop at lt_travel into data(ls_travel).
       ...
       if ( ls_travel-OverallStatus = 'X' ).
           ...
           AUTHORITY-CHECK OBJECT 'ZMTSH_MGR'
           ID 'ACTVT' FIELD '03'.
           IF sy-subrc = 0.
               lv_auth = abap_true.
           ENDIF.
...
*  here is where we need to integrate code to generate the travel id using SNRO and use that to pass automatic travel id F2 key
    data: entity type STRUCTURE FOR CREATE zmt_sh_travel,
...
*        CATCH cx_number_ranges.
   ...
   ""Step 7: Loop over the incoming travel data and assign the numbers from number range and
   ...
   loop at entities_wo_travelid into entity.
       ...
       append value #( %cid = entity-%cid
                       %is_draft = entity-%is_draft "Added for draft feature usage
 ...
 ENDMETHOD.
  ...
  METHOD copyTravel.
    data: travels type table for create zmt_sh_travel\\Travel,
         bookings_cba type table for create zmt_sh_travel\\Travel\_Booking,
         booksuppl_cba type table for create zmt_sh_travel\\Booking\_BookingSupplement.
   ...
   MODIFY ENTITIES OF zmt_sh_travel IN LOCAL MODE
       ENTITY travel
...
*    Return the total amount in mapped so the RAP will modify this data to DB
  ...
  ""reusing the code which we implemented earlier as internal action
   MODIFY entities of ZMT_sh_TRAVEL in local mode
       ENTITY travel
...
*         entities_c =
  ...
  METHOD acceptTravel.
   ...
   MODIFY ENTITIES OF zmt_sh_travel
       ENTITY travel
   ...
   READ ENTITIES OF zmt_sh_travel
       ENTITY Travel
           ALL FIELDS
               WITH CORRESPONDING #( keys )
