CLASS zmt_sh_data_builder DEFINITION
 PUBLIC
 FINAL
 CREATE PUBLIC .
 PUBLIC SECTION.
...
ENDCLASS.
CLASS zmt_sh_data_builder IMPLEMENTATION.
...
*        output =
 ...
 METHOD fill_master_data.
   data : lt_bp type table of zmt_sh_bpa,
          lt_prod type table of zmt_sh_product.
   append value #(
  ...
  append value #(
   ...
   append value #(
                   ...
                   to lt_prod.
    insert zmt_sh_bpa from table @lt_bp.
    insert zmt_sh_product from table @lt_prod.
 ENDMETHOD.
 METHOD fill_transaction_data.
   data : o_rand type REF TO cl_abap_random_int,
          ...
          lv_ord_id type zmt_sh_dte_id,
          lt_so type table of zmt_sh_so_hdr,
          lt_so_i type table of zmt_sh_so_item.
   ...
   select * from zmt_sh_bpa into table @data(lt_bpa).
   select * from zmt_sh_product into table @data(lt_prod).
   do 50 times.
       ...
       enddo.
   enddo.
   insert zmt_sh_so_hdr from table @lt_so.
   insert zmt_sh_so_item from table @lt_so_i.
 ENDMETHOD.
 METHOD flush.
   delete from : zmt_sh_bpa, zmt_sh_product, zmt_sh_so_hdr, zmt_sh_so_item.
 ENDMETHOD.
ENDCLASS.
