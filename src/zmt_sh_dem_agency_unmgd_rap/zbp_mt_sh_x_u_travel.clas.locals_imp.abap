...
* begin of changes
types: tt_travel_failed TYPE table for failed Zmt_sh_X_U_TRAVEL,
        tt_travel_reported type table for REPORTED Zmt_sh_X_U_TRAVEL.
...
* begin of replacing with custom code
  METHOD create.
...
*          et_messages            =
 ...
 METHOD map_messages.
   ...
   LOOP AT messages INTO DATA(message).
     ...
     ENDLOOP.
 ENDMETHOD.
* end of replacing with custom code
...
CLASS lsc_ZMT_SH_X_U_TRAVEL DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZMT_SH_X_U_TRAVEL IMPLEMENTATION.
